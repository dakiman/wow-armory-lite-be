...
class Character extends Model
{
    ...
    /**
     * Find or create a character by its unique identifiers.
     */
    ...
    /**
     * Scope for most searched characters.
     */
    ...
    /**
     * Scope for recently searched characters.
     */
    ...
    /**
     * Get the TTL in seconds for character data.
     */
    protected function getDataTtlSeconds(): int
    {
        return (int) config('blizzard.character_min_seconds_update', 3600);
    }
